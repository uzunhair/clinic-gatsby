...
const OmsInformationPage = () => {
  return (
    <LayoutWidthContainer title="Информация по ОМС" breadcrumbActive="Информация по ОМС">
      <p>
        <a
          href="/okazaniye_grazhdanam_RF_besplatnoj_medicinskoj_pomoshchi.pdf">
          Программа госгарантий оказания гражданам РФ бесплатной медицинской помощи
        </a>
      </p>
      <p>
        <a href="/prava_i_obyazannosti_grazhdan_v_sfere_zdravoohraneniya.pdf">
          Права и обязанности граждан в сфере здравоохранения.
        </a>
      </p>
      <p>
        <a href="/prava_i_obyazannosti_zastrahovannyh_lic.pdf">Права и обязанности застрахованных лиц</a>
      </p>
      <p>
        <a href="/Perechen_zhiznenno_neobhodimyh_i_vazhnejshih_lekarstvennyh_preparatov_i_predelnyh_otpusknyh_cen.pdf">
          Перечень жизненно необходимых и важнейших лекарственных препаратов и предельных отпускных цен
        </a>
      </p>
      <p>
        <a href="/Territorialnaya-programma.pdf">Территориальная программа</a>
      </p>
      <p>
        <a href="/Order_Ministry_of_Health_Russia_ot_30_decabry_2014_g_956n.pdf">
